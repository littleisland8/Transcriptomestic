...
## Filter low counts gene, filter out genes low count
...
pdf(file.path(opt$output,"cluster_dendo.vst.pdf"), height=as.numeric(opt$Height), width=as.numeric(opt$width))
plot(hclust(sampleDists, method = "ward.D2"))
dev.off()
